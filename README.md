...
이를 해결하기 위해 다음 두 가지 **보정 전략**을 적용하였습니다.
...
# 군집화
기여도를 측정하기에 앞서 우리가 선정한 피쳐들을 토대로 어떤 부류의 플레이어들이 많은지 알고자 한다. kmeans를 이용해 각 라인별로 군집화를 시도하였다. k의 개수를 정하는 것은 엘보우 기법을 적용한 kneed 라이브러리를 이용해 자동으로 선정하였다. 14분 이전과 이후로 피쳐를 나누어 사용하였다.
...
# 그룹별 기여도 산정
분류한 그룹별 평균 기여도를 산정하고자 한다. 같은 플레이스타일로 분류된 것들을 평균 내었다.
![top](./kmeans/top_04_Contribution_Analysis.png)
![jug](./kmeans/jug_04_Contribution_Analysis.png)
![mid](./kmeans/mid_04_Contribution_Analysis.png)
![bot](./kmeans/bot_04_Contribution_Analysis.png)
